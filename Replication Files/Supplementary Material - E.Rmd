---
title: "Annex D: Robustness Checks for Full Sample, Muslim majority measure replaced"
author: "Winston Wee"
output: 
  html_document:
    df_print: paged
...
## Table E1: Relationship between Logged Population and Participatory Democracy

```{r,echo=TRUE,tidy=TRUE,results='asis'}
# Mediator Outcome
ATE_none=lm(v2x_partipdem~ln_popn+prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+ethfrac_alesina2003+muslim_pc_imputed+as.factor(year),data=sample.VDem)

ATE_Client=lm(v2x_partipdem~ln_popn+v2xnp_client+prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+ethfrac_alesina2003+muslim_pc_imputed+as.factor(year),data=sample.VDem)

ATE_milrate=lm(v2x_partipdem~ln_popn+milrate+prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+ethfrac_alesina2003+muslim_pc_imputed+as.factor(year),data=sample.VDem)

vdem.4a=lm(v2x_partipdem~ln_popn+v2xnp_client+milrate+prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+ethfrac_alesina2003+muslim_pc_imputed+as.factor(year),data=sample.VDem)

vdem.4b=lm(v2x_partipdem~ln_popn+v2xnp_client+milrate+prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+muslim_pc_imputed+country+as.factor(year),data=panel.VDem)

mo1=lm(v2x_partipdem~ln_popn*prop_urban+v2xnp_client*prop_urban+milrate*prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+ethfrac_alesina2003+muslim_pc_imputed+as.factor(year),data=sample.VDem)

mofe=lm(v2x_partipdem~ln_popn*prop_urban+v2xnp_client*prop_urban+milrate*prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+muslim_pc_imputed+country+as.factor(year),data=panel.VDem)
...
stargazer(final.mod,
          type="latex",
          header=F,
          title="Table E1: Relationship between Logged Population and Participatory Democracy",
          ...
          covariate.labels=c("Population (Logged)","Clientelism",
                             ...
                             "Ethnic Fractionalization","% Muslims",
                             "Population <span>&#215;</span> Urbanization",
                             "Clientelism <span>&#215;</span> Urbanization",
                             "MPR <span>&#215;</span> Urbanization"),
          notes.align="l")#,out="Final Annex Table/Table E1.html")
```

## Table E2: Relationship between Logged Population and Military Participation Rate (Table 4 in thesis)

```{r,echo=TRUE,tidy=TRUE,results='asis'}

#Exposure Mediator (Milrate)

vdem.6a=lm(milrate~ln_popn+v2xnp_client+prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+ethfrac_alesina2003+muslim_pc_imputed+as.factor(year),data=sample.VDem)

vdem.6b=lm(milrate~ln_popn+v2xnp_client+prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+muslim_pc_imputed+country+as.factor(year),data=panel.VDem)

em_milrate=lm(milrate~ln_popn*prop_urban+v2xnp_client*prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+ethfrac_alesina2003+muslim_pc_imputed+as.factor(year),data=sample.VDem)

emfe_milrate=lm(milrate~ln_popn*prop_urban+v2xnp_client*prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+muslim_pc_imputed+country+as.factor(year),data=panel.VDem)
...
stargazer(em.mod,
          type="latex",
          header=F,
          title="Table E2: Relationship between Logged Population and Military Participation Rate",
          ...
          covariate.labels=c("Population (Logged)","Clientelism",
                             ...
                             "Population <span>&#215;</span> Urbanization",
                             "Clientelism <span>&#215;</span> Urbanization"),
          notes.align="l")#,out="Final Annex Table/Table E2.html")
```

## Table E3: Relationship between Logged Population and Clientelism (Table 3 in thesis)

```{r,echo=TRUE,tidy=TRUE,results='asis'}

#Exposure Mediator (Clientelism)

vdem.8a=lm(v2xnp_client~ln_popn+milrate+prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+ethfrac_alesina2003+muslim_pc_imputed+as.factor(year),data=sample.VDem)

vdem.8b=lm(v2xnp_client~ln_popn+milrate+prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+muslim_pc_imputed+country+as.factor(year),data=panel.VDem)

em_client=lm(v2xnp_client~ln_popn*prop_urban+milrate*prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+ethfrac_alesina2003+muslim_pc_imputed+as.factor(year),data=sample.VDem)

emfe_client=lm(v2xnp_client~ln_popn*prop_urban+milrate*prop_urban+ln_gdppc+govexpend_ratio+total_odashare_oecd+resourcerent+muslim_pc_imputed+country+as.factor(year),data=panel.VDem)
...
stargazer(em.mod,
          ...
          covariate.labels=c("Population (Logged)",
                             ...
                             "Population <span>&#215;</span> Urbanization",
                             "MPR <span>&#215;</span> Urbanization"),
          notes.align="l")#,out="Final Annex Table/Table E3.html")
```
